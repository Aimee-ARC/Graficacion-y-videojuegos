...
namespace VideojuegosPNo2
{
    public class VRope
    {
        ...
        public VRope(float x, float y, int segments, float interval, int id, float mass)
        {
            pts = new List<VPoint>();
            pls = new List<VPole>();
            for (int i = 0; i < segments; i++)
        ...
        public VRope(float x, float y, int segments, float interval, int id, float mass, int radio)
        {
            pts = new List<VPoint>();
            pls = new List<VPole>();
            for (int i = 0; i < segments; i++)
