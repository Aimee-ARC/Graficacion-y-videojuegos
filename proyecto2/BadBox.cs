...
namespace VideojuegosPNo2
{
    public class BadBox
    {
        ...
        public BadBox(int x, int y, int width, int height, int id)
        {
            this.width = width;
            this.height = height;
            ...
            a = new VPoint(x - (width / 2), y - (height / 2), id, true, 10);
            b = new VPoint(x + (width / 2), y - (height / 2), id + 1, true, 10);
            c = new VPoint(x + (width / 2), y + (height / 2), id + 2, true, 10);
            d = new VPoint(x - (width / 2), y + (height / 2), id + 3, true, 10);
