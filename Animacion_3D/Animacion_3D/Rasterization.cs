...
namespace Animacion_3D
{
    public class Rasterization
    {
        ...
        Model cube;
        Camera camera = new Camera(new Vertex(0, 0, 0), Matrix.RotY(0));
        ...
        public int AddModel(List<Vertex> vertexes, List<Triangle> triangles)
        {
            ...
            models.Add(model);
            instances.Add(new Instance(model, new Vertex(0, 0, 7.5f), Matrix.RotY(0)));
        ...
        public void Scales(float scale, int index)
        {
            ...
            instances[index].transform *= Matrix.MakeScalingMatrix(s);
        ...
        public void Rotate(Vertex angle, int index)
        {
            ...
            instances[index].transform *= Matrix.Rotate(rot);
        ...
        public void Translate(Vertex translation, int index)
        {
            ...
            instances[index].transform *= Matrix.MakeTranslationMatrix(tras);
        ...
        public void Animate(int frame, int initialFrame)
        {
            ...
            {
                Transform transformation = instances[i].FindTransformation(frame);
